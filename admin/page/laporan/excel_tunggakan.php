...
if (isset($_POST['excel'])) {
  ...
  header("Content-Disposition: attachment; filename=DATA KEKURANGAN $kelas_post-$jurusan_post.xls");
?>
<h3 align="center">LAPORAN KEKURANGAN PEMBAYARAN</h3>
  <table>
      <tr>
        <td><b>KELAS</b></td>
    ...
    <!-- kelas SEMUA jurusan SEMUA -->
            ...
            $query1 = "SELECT * FROM tb_jenis_tagihan WHERE kelas='$kls_semua' AND jurusan='$jrsn_semua'";
              ...
              $result_byr1 = mysqli_query($koneksi,$pembayaran1);
                ...
                $jumlah_bayar1 = $jml_byr1;
              }

              $jml_tgkn1 = $jml_tghn1 - $jml_byr1;
              $jumlah_tunggakan1 = $jml_tgkn1;
    ...
    <!-- kelas post jurusan SEMUA -->
            ...
            $query2 = "SELECT * FROM tb_jenis_tagihan WHERE kelas='$kelas_post' AND jurusan='$jrsn_semua'";
              ...
              $result_byr2 = mysqli_query($koneksi,$pembayaran2);
                ...
                $jumlah_bayar2 = $jml_byr2;
              }

              $jml_tgkn2 = $jml_tghn2 - $jml_byr2;
              $jumlah_tunggakan2 = $jml_tgkn2;
    ...
    <!-- kelas post jurusan post -->
            ...
            $query3 = "SELECT * FROM tb_jenis_tagihan WHERE kelas='$kelas_post' AND jurusan='$jurusan_post'";
              ...
              $result_byr3 = mysqli_query($koneksi,$pembayaran3);
                ...
                $jumlah_bayar3 = $jml_byr3;
              }

              $jml_tgkn3 = $jml_tghn3 - $jml_byr3;
              $jumlah_tunggakan3 = $jml_tgkn3;
...
if ($jumlah_tgkn == 0) {
    $jumlah_tunggakan = "";
        ...
        $jumlah_tunggakan =  $jumlah_tgkn;
    }   
?>
            <!-- <td><b><?= $jumlah_bayar; ?></b></td> -->
            <td><b><?= $jumlah_tunggakan; ?></b></td>
            <!-- <td><b><?= $jumlah_tagihan; ?></b></td>  -->
          </tr>
<?php } ?> <!-- end siswa-->
        </tbody>
...
if ($total_tgkn == 0) {
  $total_tunggakan = "";
      ...
      $total_tunggakan =  $total_tgkn;
  }
 ?>      
            <td align="center"><b><?= $total_tunggakan; ?></b></td>
          </tr>
        </tfoot>
      </table>
      <br>
