...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h1 class="h4 mb-0 text-gray-650 text-center">DATA PEMBAYARAN</h1>
    <table>
      <tr>
      ...
      <tr>
        <td colspan="2"><form method='post' class='d-sm-inline-block form-inline' action="index.php?page=rincian_pembayaran">
          ...
          <form method='post' class='d-sm-inline-block form-inline' action="page/laporan/rincian_pembayaran_print.php" target="blank">
            <input type="hidden" name="id_siswa" value="<?= $id_siswa; ?>">
