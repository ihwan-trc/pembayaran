...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h1 class="h5 mb-0 text-gray-650 text-center">DATA KEKURANGAN PEMBAYARAN</h1>
    <table>
      <tr>
      ...
      <tr>
        <td colspan="2"><form method='post' class='d-sm-inline-block form-inline' action="index.php?page=rincian_tunggakan">
          ...
          <form method='post' class='d-sm-inline-block form-inline' action="page/laporan/rincian_tunggakan_print.php" target="blank">
            <input type="hidden" name="id_siswa" value="<?= $id_siswa; ?>">
