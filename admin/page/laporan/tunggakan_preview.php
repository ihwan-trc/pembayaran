...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h1 class="h5 mb-0 text-gray-650 text-center">LAPORAN KEKURANGAN PEMBAYARAN</h1>
    <table>
      <tr>
        <td><b>KELAS</b></td>
      ...
      <tr>
        <td colspan="2"><form method='post' class='d-sm-inline-block form-inline' action="index.php?page=tunggakan">
            ...
            <form method='post' class='d-sm-inline-block form-inline' action="page/laporan/tunggakan_print.php" target="blank">
              <input type="hidden" name="kelas" value="<?= $kelas_post; ?>">
              <input type="hidden" name="jurusan" value="<?= $jurusan_post; ?>">
