...
$spreadsheet->getProperties()->setCreator('SMK MIFTAHUL ULUM')
					   ...
					   ->setTitle("FORMAT IMPORT SISWA")
					   ->setSubject("Kelas-Jurusan")
					   ->setDescription("Format Import Data Siswa")
					   ->setKeywords("Siswa");
...
$spreadsheet->setActiveSheetIndex(0)->setCellValue('A1', "NIS"); // Set kolom A1 dengan tulisan "NO"
$spreadsheet->setActiveSheetIndex(0)->setCellValue('B1', "NAMA SISWA"); // Set kolom B1 dengan tulisan "NIS"
$spreadsheet->setActiveSheetIndex(0)->setCellValue('C1', "KELAS"); // Set kolom C1 dengan tulisan "NAMA"
$spreadsheet->setActiveSheetIndex(0)->setCellValue('D1', "JURUSAN"); // Set kolom C1 dengan tulisan "NAMA"
$spreadsheet->setActiveSheetIndex(0)->setCellValue('F3', "Note : Pastikan penulisan kelas dan jurusan sama dengan sistem"); // Set kolom C1 dengan tulisan "NAMA"
...
$spreadsheet->getActiveSheet()->getColumnDimension('C')->setWidth(10); // Set width kolom C
...
$spreadsheet->getActiveSheet(0)->setTitle("FORMAT IMPORT SISWA");
...
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header("Content-Disposition: attachment; filename=format-import-Siswa.xlsx");
