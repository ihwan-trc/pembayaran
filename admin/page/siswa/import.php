  ...
  <div class="card-body">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      <li class="nav-item" role="presentation">
        <a class="nav-link active" id="siswa-tab" data-toggle="tab" href="#siswa" role="tab" aria-controls="siswa" aria-selected="true"><b>SISWA</b></a>
      </li>
      <li class="nav-item" role="presentation">
        <a class="nav-link" href="index.php?page=import_baak">BAAK</a>
      </li>
    </ul>
...
<!-- ========================================siswa=================================================== -->
      <div class="tab-pane fade show active" id="siswa" role="tabpanel" aria-labelledby="siswa-tab">
        ...
        <div class="py-3">
          <form action="page/siswa/format_import.php" method="post">
            <button class="btn btn-sm btn-success" type="submit" name="format"><i class="fas fa-download"></i> Format Import Siswa</button>
          </form>
        </div>
          ...
          <div class="form-row">
            <div class="form-group col-5">
              <div class="custom-file">
                <input type="file" class="custom-file-input" id="dt-import_siswa" name="file" required="" onchange="return validasiFile()"/>
                <label class="custom-file-label" for="customFile">Masukkan file Excel 2007 (*.xlsx)</label>
              </div>
            </div>
            <div>
              <button type="submit" class="btn  btn-info" name="preview_siswa"><i class="fas fa-eye"></i> Preview</button>
            </div>
          </div>
        </form>
    ...
    <!-- Buat Preview Data -->
          ...
          if(isset($_POST['preview_siswa'])){
            ...
            if($ext == "xlsx"){
              ...
              echo "<form method='post' action='page/siswa/proses_import.php'>";
              // Buat sebuah tombol untuk mengimport data ke database
                echo "<button type='submit' name='import_siswa' class='btn btn-sm btn-primary'>
              ...
              foreach($sheet as $row){ // Lakukan perulangan dari data yang ada di excel
                ...
                if($nis == "" && $nama_siswa == "" && $kelas == ""  && $jurusan == "")
                ...
                if($numrow > 1){
                  ...
                  $nama_siswa_td = ( ! empty($nama_siswa))? "" : " style='background: #E07171;'"; // Jika Nama kosong, beri warna merah
                  ...
                  if($nis == "" or $nama_siswa == "" or $kelas == "" or $jurusan == ""){
      ...
      <script type="text/javascript">
        var uploadField = document.getElementById("dt-import_siswa");
        uploadField.onchange = function() {
            if(this.files[0].size > 2000000){
               alert("Maaf. Ukuran File Terlalu Besar ! Maksimal Upload 2 MB");
               this.value = "";
            };
                var inputFile = document.getElementById('dt-import_siswa');
