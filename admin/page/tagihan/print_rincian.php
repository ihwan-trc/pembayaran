...
<body>
    <center>
      <div id=halaman>
        <table width="850">
            <tr>
                <td width="80"><img src="../../asset/img/<?= $logo ?>" width="80" height="80"></td>
                <td width="690">
                <center>
    ...
    <table width="850">
      <tr>
        ...
        <td width="740"><b>: <?= $nama_siswa; ?></b></td>
      </tr>
      <tr>
        <td><b>KELAS</b></td>
        <td width="740"><b>: <?= $kelas; ?></b></td>
      </tr>
      <tr>
        <td><b>JURUSAN</b></td>
        <td width="740"><b>: <?= $jurusan; ?></b></td>
      </tr>
    </table>
      ...
      <table class="border" width="850">
        <thead>
          <tr bgcolor="#e6e4df">
            ...
            <th class="border">TAGIHAN</th>
            <th class="border">JUMLAH PEMBAYARAN</th>
            <th class="border">JUMLAH KEKURANGAN</th>
        ...
        <!-- ================================================1=================================================== -->
          ...
          <tr>
            ...
            <td class="border"><?= $jumlah_tagihan1; ?></td>
            <td class="border"><?= $jumlah_bayar1; ?></td>
...
<!-- ================================================2=================================================== -->
          ...
          <tr>
            ...
            <td class="border"><?= $jumlah_tagihan2; ?></td>
            <td class="border"><?= $jumlah_bayar2; ?></td>
...
<!-- ================================================3=================================================== -->
          ...
          <tr>
            ...
            <td class="border"><?= $jumlah_tagihan3; ?></td>
            <td class="border"><?= $jumlah_bayar3; ?></td>
...
if ($idsiswa4 !== NULL) {
 ?>
          ...
          <tr>
            ...
            <td class="border"><?= $jumlah_tagihan4; ?></td>
            <td class="border"><?= $bayar4;?> </td>
...
// jumlah bayar
          ...
          <tr>
            ...
            <td class="border" align="center"><b><?= number_format($jumlah_tagihan,0,",","."); ?></b></td>
            <td class="border" align="center"><b><?=$jumlah_bayar;?></b></td>
            <td class="border" align="center"><b><?=$jumlah_tunggakan;?></b></td>
            <td class="border" align="center"><b><?=$status_total;?></b></td>
          </tr>
        </tfoot>
      </table>
      <br>
