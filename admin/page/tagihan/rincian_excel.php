...
$spreadsheet->getProperties()
			...
			->setTitle("Data Rincian")
			->setSubject("Rincian Pembayaran")
			->setDescription("Data Pembayaran Siswa")
...
$spreadsheet->setActiveSheetIndex(0)->setCellValue('A1', "DATA PEMBAYARAN");
...
$spreadsheet->setActiveSheetIndex(0)->setCellValue('A5', "NO"); // Set kolom A5 dengan tulisan "NO"
$spreadsheet->setActiveSheetIndex(0)->setCellValue('B5', "JENIS TAGIHAN"); // Set kolom B5 dengan tulisan "NIS"
$spreadsheet->setActiveSheetIndex(0)->setCellValue('C5', "TAGIHAN"); // Set kolom C5 dengan tulisan "NAMA"
$spreadsheet->setActiveSheetIndex(0)->setCellValue('D5', "PEMBAYARAN"); // Set kolom D5 dengan tulisan "JENIS KELAMIN"
$spreadsheet->setActiveSheetIndex(0)->setCellValue('E5', "TUNGGAKAN"); // Set kolom E5 dengan tulisan "TELEPON"
$spreadsheet->setActiveSheetIndex(0)->setCellValue('F5', "KETERANGAN"); // Set kolom F4 dengan tulisan "ALAMAT"
...
$spreadsheet->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $tunggakan1);
...
$spreadsheet->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $tunggakan2);
...
$spreadsheet->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $tunggakan3);
...
$spreadsheet->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $tunggakan4);
...
$spreadsheet->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $jumlah_tunggakan);
...
$spreadsheet->getActiveSheet(0)->setTitle("Data Rincian");
$spreadsheet->setActiveSheetIndex(0);

// Proses file excel
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header("Content-Disposition: attachment; filename=$nama_siswa $kelas-$jurusan.xlsx");
