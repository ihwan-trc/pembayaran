...
error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
 ...
 ?>
<link rel="shortcut icon" href="../admin/asset/img/<?= $logo ?>" type="image/x-icon">
...
<html>
<head>
    <title>DATA KEKURANGAN PEMBAYARAN</title>
    <style type="text/css">
        table {
            border-style: double;
            border-width: 3px;
...
<body>
    <center>
      <div id=halaman>
        <table width="625">
            <tr>
                <td><img src="../admin/asset/img/<?= $logo ?>" width="80" height="80"></td>
                <td>
                <center>
        ...
        <h4>DATA KEKURANGAN PEMBAYARAN</h4>
        <table>
            <tr class="text2">
                <td>NAMA SISWA</td>
                <td width="530">: <?= $nama_siswa; ?></td>
            </tr>
            <tr>
                <td>KELAS</td>
                <td width="530">: <?= $kelas; ?></td>
            </tr>
            <tr>
                <td>JURUSAN</td>
                <td width="530">: <?= $jurusan; ?></td>
            </tr>
        </table>
